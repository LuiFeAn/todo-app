...
export default function Modal({ 
    ...
    return (
        <div className="absolute h-screen backdrop-blur-[2px] w-screen z-50 text-black font-bold">
           ...
           <div className={`fixed bg-white w-[450px] top-[200px] left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl shadow-[0_120px_120px_100px_rgba(0,0,0,0.3)] p-[20px] max-sm:w-[320px] max-sm:h-auto ${customStyle}`}>
